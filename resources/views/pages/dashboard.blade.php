<x-section breadcrumbTitle="Dashboard">
                ...
                <tr>
                        ...
                        <div class="d-flex align-items-center">
                            <span
                                class="avatar avatar-sm shadow-sm rounded-circle me-1 d-flex align-items-center justify-content-center bg-white"><img
                                    src="../assets/svg/icons/facebook2.svg" alt="Facebook"></span><span
                    ...
                    <td>
                        <div class="dropdown text-end">
                            <a href="#" class="btn btn-dark-100 btn-icon btn-sm rounded-circle" role="button"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <svg data-name="Icons/Tabler/Notification" xmlns="http://www.w3.org/2000/svg"
                                    width="13.419" height="13.419" viewBox="0 0 13.419 13.419">
                                    <rect data-name="Icons/Tabler/Dots background" width="13.419" height="13.419"
                                        fill="none" />
                                    <path
                ...
                <tr>
                    <td>
                        <div class="d-flex align-items-center">
                            <span
                                class="avatar avatar-sm shadow-sm rounded-circle me-1 d-flex align-items-center justify-content-center bg-white"><img
                                    src="../assets/svg/icons/medium.svg" alt="Facebook"></span>
                ...
                <tr>
                    <td>
                        <div class="d-flex align-items-center">
                            <span
                                class="avatar avatar-sm shadow-sm rounded-circle me-1 d-flex align-items-center justify-content-center bg-white"><img
                                    src="../assets/svg/icons/google-icon.svg" alt="Facebook"></span>
